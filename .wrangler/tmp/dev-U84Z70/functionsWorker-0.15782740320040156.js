...
// .wrangler/tmp/pages-QXIim3/functionsWorker-0.15782740320040156.mjs
...
var toBase64Url = /* @__PURE__ */ __name2((bytes) => btoa(String.fromCharCode(...new Uint8Array(bytes))).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/, ""), "toBase64Url");
var fromBase64Url = /* @__PURE__ */ __name2((text) => {
...
__name2(logStatement, "logStatement");
...
__name2(existingBoards, "existingBoards");
...
__name2(boardSummary, "boardSummary");
...
__name2(clearBoardStatements, "clearBoardStatements");
var MAX_REASON = 200;
var LOG_LIMIT = 30;
...
__name2(loadTarget, "loadTarget");
var isSelf = /* @__PURE__ */ __name2((auth, account) => auth.username.toLowerCase() === account.username.toLowerCase(), "isSelf");
...
async function onRequestPost(context2) {
  ...
  try {
    ...
    const log3 = /* @__PURE__ */ __name2((action, details) => logStatement(env2, auth.username, action, name, details), "log");
...
var isGame = /* @__PURE__ */ __name2((id) => typeof id === "string" && GAMES.includes(id), "isGame");
...
__name2(validateDocument, "validateDocument");
...
__name2(resolveGame, "resolveGame");
...
// .wrangler/tmp/bundle-NK3clG/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-NK3clG/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.15782740320040156.js.map
